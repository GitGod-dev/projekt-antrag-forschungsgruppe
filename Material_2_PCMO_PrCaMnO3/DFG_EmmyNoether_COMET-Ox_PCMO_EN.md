...
\[E4\] M. Buczek, \[co-authors\], W. C. Chueh, \[working title: An experimental covalency scale for memristive Pr<sub>1-x</sub>Ca<sub>x</sub>MnO<sub>3</sub>\]. Manuscript in preparation (Feodor Lynen fellowship; update status at submission time).
