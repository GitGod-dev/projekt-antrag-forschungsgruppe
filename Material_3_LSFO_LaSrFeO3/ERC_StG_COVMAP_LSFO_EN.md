...
|----|----|
| \[2027\] – present | Feodor Lynen Research Fellow (Alexander von Humboldt Foundation), group of Prof. W. C. Chueh, Stanford University / SLAC – covalency descriptors for memristive switching: epitaxial La<sub>1-x</sub>Sr<sub>x</sub>FeO<sub>3-δ</sub> pilot series, XAS covalency scale at SSRL \[manuscript in preparation, P1\] |
...
P1. M. Buczek, \[co-authors\], W. C. Chueh, \[working title: An experimental covalency scale for memristive La<sub>1-x</sub>Sr<sub>x</sub>FeO<sub>3-δ</sub>\], manuscript in preparation (from the Feodor Lynen fellowship; insert status – in preparation / submitted / published – at submission time).
