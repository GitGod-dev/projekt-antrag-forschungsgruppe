...
Covalency as an Experimental Descriptor of Memristive Switching: the La1-xSrxFeO3-δ Series
...
\[9\] A. M. Ritzmann, A. B. Muñoz-García, M. Pavone, J. A. Keith, E. A. Carter, Ab Initio DFT+U Analysis of Oxygen Vacancy Formation and Migration in La1-xSrxFeO3-δ (x = 0, 0.25, 0.50). Chemistry of Materials 25, 3011–3019 (2013).
...
\[12\] V. R. Nallagatla et al., Topotactic Phase Transition Driving Memristive Behavior (SrFeO2.5/SrFeO3). Advanced Materials 31, 1903391 (2019).

\[13\] J. Tian et al., Nanoscale Topotactic Phase Transformation in SrFeOx Epitaxial Thin Films for High-Density Resistive Switching Memory. Advanced Materials 31, 1903679 (2019).

\[14\] R. K. Aljurays, A. Loucif, A. M. Albadri, Synthesis of LaXO3 (X = Fe, Mn, Cr, Ni) Thin Films Using a Simple Spin Coating Set-Up for Resistive Switching Memory Devices. Electronics 12, 4141 (2023).

\[15\] P. Nizet et al., Analog control of La0.5Sr0.5FeO3-δ electrical properties through oxygen deficiency induced magnetic transition. Applied Physics Reviews 11, 041426 (2024).
...
\[43\] E. Stavitski, F. M. F. de Groot, The CTM4XAS program for EELS and XAS spectral shape analysis of transition metal L edges. Micron 41, 687-694 (2010).

\[44\] M. W. Haverkort, M. Zwierzycki, O. K. Andersen, Multiplet ligand-field theory using Wannier orbitals. Physical Review B 85, 165113 (2012).
