...
|----|----|
| \[2027\] – present | Feodor Lynen Research Fellow (Alexander von Humboldt Foundation), group of Prof. W. C. Chueh, Stanford University / SLAC – reducibility descriptors in the fluorite class: epitaxial Ce<sub>1-x</sub>Gd<sub>x</sub>O<sub>2-δ</sub> series on the Pt/Pt crossbar platform, XAS covalency scale at SSRL \[manuscript in preparation, P1\] |
...
P1. M. Buczek, \[co-authors\], W. C. Chueh, \[working title: An experimental reducibility descriptor for Pt/Ce1-xGdxO2-δ/Pt memristive crossbars\], manuscript in preparation (from the Feodor Lynen fellowship; insert status – in preparation / submitted / published – at submission time).
