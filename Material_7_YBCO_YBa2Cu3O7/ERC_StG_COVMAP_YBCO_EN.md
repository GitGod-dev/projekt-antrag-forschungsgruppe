...
|----|----|
| \[2027\] – present | Feodor Lynen Research Fellow (Alexander von Humboldt Foundation), group of Prof. W. C. Chueh, Stanford University / SLAC – covalency descriptors beyond the perovskites: epitaxial YBa<sub>2</sub>Cu<sub>3</sub>O<sub>7-δ</sub> chain-oxygen series with Au-contact devices, XAS covalency scale at SSRL \[manuscript in preparation, P1\] |
...
P1. M. Buczek, \[co-authors\], W. C. Chueh, \[working title: A site-resolved covalency scale for noble-electrode YBa2Cu3O7-δ memristive devices\], manuscript in preparation (from the Feodor Lynen fellowship; insert status – in preparation / submitted / published – at submission time).
