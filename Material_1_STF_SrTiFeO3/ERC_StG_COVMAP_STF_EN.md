...
|----|----|
| \[2027\] – present | Feodor Lynen Research Fellow (Alexander von Humboldt Foundation), group of Prof. W. C. Chueh, Stanford University / SLAC – covalency descriptors for intrinsic memristive switching: epitaxial SrTi<sub>1-x</sub>Fe<sub>x</sub>O<sub>3-δ</sub> pilot series with graphene-sealed devices, XAS covalency scale at SSRL \[manuscript in preparation, P1\] |
...
P1. M. Buczek, \[co-authors\], W. C. Chueh, \[working title: An experimental covalency scale for intrinsically switching SrTi<sub>1-x</sub>Fe<sub>x</sub>O<sub>3-δ</sub> memristive devices\], manuscript in preparation (from the Feodor Lynen fellowship; insert status – in preparation / submitted / published – at submission time).
